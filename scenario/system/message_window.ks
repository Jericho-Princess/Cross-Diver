;メッセージレイヤの定義
		...
		[position width=1260 height=288 top=432 left=35 ]
			...
			[position page=fore frame="041.png" margint=80 marginl=50 marginr=50 marginb=80 vertical=false opacity="200" ]
		...
		[position layer="message1" page=fore margint=5 marginl=10 marginr=10 marginb=10 vertical=false opacity="200" radius="20" color="0x000000" ]
