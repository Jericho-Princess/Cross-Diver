...
[tb_start_text mode=1 ]
たしかに彼には、罪の悔い改めが必要かもしれない。[r]でも、そのあとまた生まれ変われるかもしれない。[p]
[_tb_end_text]

[name_dhunter]

[tb_start_text mode=1 ]
あぁ、もっと罪を犯すようになるかもな。[r]今度は人を殺したりするんじゃないのか？[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
そうか？[p]
だが罪を重ねることはほぼ間違いないだろう。[r]お前がそう思っているようにな。[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
だが勘違いはするなよ？ちゃんと良い薬も用意してある。[r]しっかりここで苦しむといい。[p]
[_tb_end_text]
