...
; gameover.ks 共通リトライ用：Chapter109から倒れた場合はダイブ開始地点へ戻す


[eval exp="f.gameover_retry_id = 109"]
...
ダイブをするのはかなり久しぶりだ。向こうの世界での目的やルールは…
[_tb_end_text]
...
[place_bg storage="rina-home.png"]
...
[place_bg storage="rina-home_entrance.png"]
...
[place_bg storage="rina-home_corridor.png"]
...
[place_bg storage="rina-home_rf.png"]
...
[place_bg storage="rina-home_garage1.png"]
...
[wait  time="500"  ]
[bg  time="1000"  method="crossfade"  storage="rina-home_garage2.png"  ]
[name_clear]
...
[tb_start_text mode=1 ]
…。[p]
…アモちゃんが死んじゃった時、私はいっぱい泣いた。[r]帰ってきてほしかった…夜まで泣いてた…。[p]
...
[place_bg storage="rina-home_room.png"]
