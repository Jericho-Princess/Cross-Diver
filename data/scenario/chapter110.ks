...
; gameover.ks 共通リトライ用：Chapter110から倒れた場合はこの章の先頭へ戻す


[eval exp="f.gameover_retry_id = 110"]
...
[place_bg storage="rina-home_aquarium1.png"]
...
[bg  time="1000"  method="crossfade"  storage="rina-home_aquarium2.png"  ]
...
[tb_start_text mode=4 ]
これより悪霊との戦闘[font color=#FFF100] ＜ロゴスバトル＞ [resetfont]を開始します。[r]戦闘のルールを聞きますか？
[_tb_end_text]
...
戦闘時、各ターンには時間制限が存在します。[r]画面上部の赤いバーが残り時間を表し、残り時間が０になればダメージが発生します。[p]
...
[tb_start_text mode=1 ]
信じていないならそうかもしれない。[r]だが神は、信じる者を決して見捨てない。俺は神を信じている。[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
お前もすぐに神のことを忘れる。そして、神はそれを厳しく罰するだろう。[p]
[_tb_end_text]
...
[tb_start_text mode=4 ]
人間は孤独なものだ。人はそれを慰め合うが、孤独からは決して逃げられない。
[_tb_end_text]
...
[logos_timer_start storage="chapter110.ks" target="*logos2_timeout" duration="10000"]
...
[tb_start_text mode=1 ]
人間は独りじゃない。俺が彼女のそばに居続ければいいだけだ。[p]
[_tb_end_text]

[name_dfish]

[tb_start_text mode=1 ]
お前にそれができるのか？お前は何度も人を裏切り、そして悲しませた。[p]
またそれを繰り返したいのか？[p]
[_tb_end_text]
...
[logos_timer_start storage="chapter110.ks" target="*logos3_timeout" duration="10000"]
...
[tb_start_text mode=1 ]
出会って１日で何が理解できる？私は何年もここにいるのだ。[r]そして全ての悩みを聞いてきたのだ。[p]
お前は何も知らない部外者なのだ。[p]
[_tb_end_text]
...
[logos_timer_start storage="chapter110.ks" target="*logos4_timeout" duration="10000"]
...
[tb_start_text mode=1 ]
たしかに制約に満ちた人生かもしれない。それを楽しむ方法だってきっとある。[r]俺たちはそれを見つけてみせる。[p]
[_tb_end_text]
...
[logos_timer_start storage="chapter110.ks" target="*logos5_timeout" duration="10000"]
...
[tb_start_text mode=1 ]
彼女を創ったのは神様だ。彼女は神の子だ。お前には一切関係ない。[p]
イエスキリストの御名により命じる。[r]出ていけ！！[p]
[_tb_end_text]
...
[bg  time="5000"  method="crossfade"  storage="rina-home_aquarium3.png"  ]
[name_clear]
...
[wait  time="1500"  ]
[bg  time="4000"  method="crossfade"  storage="rina-home_garage2.png"  ]
[name_rina]
...
[bg  time="2000"  method="crossfade"  storage="rina-home_garage3.png"  ]
[name_clear]
...
[bg  time="3000"  method="crossfade"  storage="rina-home_garage4.png"  ]
[name_rina]
