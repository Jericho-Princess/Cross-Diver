...
[playse  volume="120"  time="1000"  buf="0"  storage="革靴で歩く.mp3"  fadein="false"  html5="false"  ]
[wait  time="2000"  ]
[stopse  time="5000"  buf="0"  fadeout="true"  ]
[bg  time="5000"  method="crossfade"  storage="council_gate.png"  ]
[glink  color="black"  storage="chapter101.ks"  size="50"  x="385"  y="420"  width="300"  height="50"  text="扉を開ける"  _clickable_img=""  target="*openthedoor"  autopos="false"  ]
[s  ]
*openthedoor
...
[tb_image_show  time="1000"  storage="default/council_screen1.png"  width="374"  height="210"  x="448"  y="123"  _clickable_img=""  name="img_17"  ]
[tb_start_text mode=1 ]
...
[tb_image_show  time="500"  storage="default/council_screen2.png"  width="373"  height="210"  x="450"  y="121"  _clickable_img=""  name="img_19"  ]
[tb_start_text mode=1 ]
...
[font  size="32"  color="0xfff100"  bold="true"  ]
[tb_start_text mode=1 ]
...
[playse  volume="100"  time="1000"  buf="0"  storage="鉄の扉を開ける.mp3"  ]
[place_bg storage="council_entrance.png"]
...
[tb_start_text mode=1 ]
（顔も合わせず、抑揚の無い喋り方。どこか人間味のない奴らだったな。）[p]
（そもそも何故、俺が選ばれたのだろうか？）[p]
[_tb_end_text]
...
[place_bg storage="council_exit.png"]
...
霊的な流れがどうなっているかは把握できても、[r]街の実際の様子はここからでは見当もつきません。[r]どうかお気をつけて。[p]
...
[tb_eval  exp="f.faith-=13"  name="faith"  cmd="-="  op="t"  val="13"  val_2="undefined"  ]
[name_system]
...
[tb_eval  exp="f.spiritual+=3"  name="spiritual"  cmd="+="  op="t"  val="3"  val_2="undefined"  ]
[name_system]
...
[tb_start_text mode=1 ]
あなたの<堅信>が大きく上昇した。[r]あなたの＜禁忌＞が少し減少した。[p]
[_tb_end_text]
