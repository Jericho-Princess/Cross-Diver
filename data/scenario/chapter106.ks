...
[place_bg storage="街の広場.png"]

[chara_show  name="コタニ"  time="1000"  wait="true"  storage="chara/3/コタニ①通常.png"  width="644"  height="968"  left="336"  top="23"  reflect="false"  ]
[name_kotani]
...
[wait  time="500"  ]
[bg  time="1500"  method="crossfade"  storage="モールのスーパー.png"  ]
[tb_show_message_window  ]
[chara_show  name="コタニ"  time="1000"  wait="true"  storage="chara/3/コタニ⑦驚愕.png"  width="822"  height="1236"  left="247"  top="37"  reflect="false"  ]
[name_kotani]
...
[playbgm  volume="70"  time="1000"  loop="true"  storage="ジングル＆ループ006.mp3"  fadein="true"  ]
...
[chara_show  name="コタニ"  time="1000"  wait="true"  storage="chara/3/コタニ⑤微笑.png"  width="714"  height="1073"  left="268"  top="69"  reflect="false"  ]
[name_kotani]
...
[chara_show  name="コタニ"  time="1000"  wait="true"  storage="chara/3/コタニ⑤微笑.png"  width="766"  height="1150"  left="254"  top="40"  reflect="false"  ]
[name_kotani]
...
[tb_start_text mode=1 ]
旧約聖書　詩篇 56:8[r]あなたはわたしのさすらいを数えられました。[r]わたしの涙をあなたの皮袋にたくわえてください。[r]これは皆あなたの書にしるされているではありませんか。[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
新約聖書　マタイによる福音書 28:20[r]見よ、わたしは世の終りまで、いつもあなたがたと共にいるのである。[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
新約聖書　ヨハネによる福音書 14:18 [r]わたしはあなたがたを捨てて孤児とはしない。[r]あなたがたのところに帰って来る。[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
新約聖書　ヨハネによる福音書 8:32[r]あなたたちは真理を知るであろう。[r]そして真理は、あなたがたに自由を得させるであろう。[p]
[_tb_end_text]
