...
彼女は本当の意味で救われてはいないのかもしれない。[p]
[r]彼女には束縛からの[font color=#FFF100] ＜解放＞ [resetfont]が必要だ…。[p]
けれど、[font color=#FFF100]俺が彼女を救えるわけじゃない。[resetfont][p]
俺にできるのは、彼女の痛みの近くまで行き、[r]そこで何が彼女を縛っているのかを見ることだけだ。[p]
解放するのは俺じゃない。[p]
俺はただ、彼女の痛みの近くまで行く。[r]それを忘れたら、あの時のように、また誰かを傷つける。[p]
解放するのは神様だ。[p]
…だとするなら、やはり ＜ダイブ＞ をするしかないか…。[p]
いや、するしかないというより、[r]その扉が開かれるなら、俺はそこに行く覚悟を決めなければならない。[p]
[_tb_end_text]

[name_system]

[tb_start_text mode=1 ]
ダイブには精神力が必要であり、その消費量は相手との信頼関係に大きく関係します。[p]
...
[tb_start_text mode=1 ]
そうなの？[p]
私も、もしかしたら、そうかも…。[r]孤独感ってさ、成長しても消えないんだよね。[r]傷跡みたいにずっと残っちゃってさ。[p]
...
[bg  time="3000"  method="crossfade"  storage="黒スクリーン.png"  ]
[tb_start_text mode=1 ]
意識を集中しろ…肉体を忘れろ…。[r]扉が見える…。[p]
[_tb_end_text]
...
[playse  volume="75"  time="1000"  buf="5"  storage="狂気.mp3"  ]
