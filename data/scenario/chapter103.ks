...
[place_bg storage="maison-de-olive.png"]

[name_clear]

[tb_start_text mode=1 ]
目的地がやっと見えてきた。きっとあのマンションだ。[p]
マンション名は、[font color=#FFF100] ＜メゾン・ド・オリーブ＞ [resetfont]。[r]見たところ普通の賃貸だ。[p]
駐車場で「迎えの男」と合流するはずだが、どこにいるのだろうか？[p]
駐車場をうろうろしていると、近くの軽自動車から１人の男性が出てきた。[p]
[_tb_end_text]

[chara_show  name="コタニ"  time="1000"  wait="true"  storage="chara/3/コタニ①通常.png"  width="714"  height="1073"  left="319"  top="22"  reflect="false"  ]
[name_kotani]
...
[tb_start_text mode=1 ]
まさかホントに来るなんて、すごいなぁ！！[p]
僕は[font color=#FFF100] ＜コタニ＞ [resetfont]です。お願いしまーす。[p]
[_tb_end_text]
