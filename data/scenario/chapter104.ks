...
[chara_show  name="コタニ"  time="1000"  wait="true"  storage="chara/3/コタニ②笑顔.png"  width="675"  height="1014"  left="338"  top="39"  reflect="false"  ]
[name_kotani]
...
[tb_start_text mode=1 ]
連絡か…悪いけど、俺はこのエリアの端末を持ってないんだ。[p]
[_tb_end_text]

[name_clear]

[tb_start_text mode=1 ]
そう。自分がいたエリアでは、こことはまた＜違う方法＞で仲間と連絡していたのだ。[p]
コタニはそれを聞いて驚いていた。[p]
[_tb_end_text]
...
[tb_image_show  time="0"  storage="default/item-frame.png"  width="424"  height="424"  x="818"  y="60"  _clickable_img=""  name="img_15"  ]
[tb_image_show  time="1000"  storage="default/phone1.png"  width="212"  height="375"  name="img_16"  x="923"  y="91"  _clickable_img=""  ]
[name_clear]
...
[tb_image_show  time="0"  storage="default/item-frame.png"  width="424"  height="424"  x="818"  y="60"  _clickable_img=""  name="img_27"  ]
[tb_image_show  time="1000"  storage="default/phone2.png"  width="215"  height="379"  x="918"  y="94"  _clickable_img=""  name="img_27"  ]
[name_clear]

[tb_start_text mode=1 ]
少し触ってみたが、アプリなどは最低限だ。[r]そして、この端末には１つのフォルダを残して、データが何も残っていない。[p]
IDは[font color=#FFF100]  ＜Sabrina109＞ [resetfont] 。[r]持ち主はどうしてこれを残していったのだろうか？[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
そうだったのか…それはすまなかった。とにかく、ありがとう。[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
それが何も聞かされていないんだよ、不思議だよねぇ。[r]なんか大事な人が来るって聞いたけど、それ以外はほとんどないね。[p]
でも、きっと神様が必要としてる人なんだってのはすぐわかったよ。[r]だから、僕は助けてあげたいと思った。それぐらいかな。[p]
[_tb_end_text]
